...
<link rel="icon" href="images/favicon.ico">
    <head>
        ...
        <title>Data Privacy And Security in Smart Classroom | Admin Dashboard</title>
    ...
    <div class="form">
        ...
        <div class="signup-content">
                <div class="signup-form">
                    ...
                    <p style="color: #777;" >You can view, remove and block devices from here.</p>
                    <p style="color: #777;">Use below button to navigate.</p>
                    <br>
                    <a type="button" class="btn btn-info" href="viewdevices.php">View Devices</a>
                    <a type="button" class="btn btn-primary" href="blockeddevices.php">Blocked Devices</a>
                    <!-- <br><br>
                    <p style="color: #777;">Use below button to alert students about the time table</p>
                    <a type="button" class="btn btn-primary notifybt" href="notify.php">Remind All</a>
                    <br><br> -->
